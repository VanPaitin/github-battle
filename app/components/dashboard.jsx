...
export default class Dashboard extends Component {
    ...
    fetchAllBucketlists() {
      console.log("success");
      request
        .get('http://life-plans.herokuapp.com/api/v1/bucketlists/')
        .set('Authorization', localStorage
              .getItem('token'))
        .end((err, result) => {
          if (result.status === 200) {
            console.log(result)
            this.setState({bucketlists: result.body.bucketlist})
          } else {
            console.log("error")
          }
        });
    ...
    saveNewBucketlist(bucketlistName) {
      ...
      request
        .post('http://life-plans.herokuapp.com/api/v1/bucketlists/')
        .set('Authorization', localStorage
              .getItem('token'))
